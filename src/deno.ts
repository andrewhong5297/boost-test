...
import { createPublicClient, http, parseUnits, Address } from "npm:viem";
...
async function handler(
  ...
  const targetContract = "0x016dF4C52fB5C0E1cb3432ebd6071a90b1F6dCD9" as const;

  const paddedCrowdfundId =
    input.crowdfundId.length % 2 === 0
